...
$parks = [
    ...
    'name' => 'Canyonlands', 
    'location' => 'Utah', 
    'date_established' => '1964-9-12', 
    'area_in_acres' => '337597',
...
$insertData = $dbc->prepare('INSERT INTO national_parks(name, location, date_established, area_in_acres, description) VALUES (:name, :location, :date_established, :area_in_acres, :description)');

foreach ($parks as $parkInfo) {
    $insertData->bindValue(':name', $parkInfo['name'], PDO::PARAM_STR);
    $insertData->bindValue(':location', $parkInfo['location'], PDO::PARAM_STR);
    $insertData->bindValue(':date_established', $parkInfo['date_established'], PDO::PARAM_STR);
    $insertData->bindValue(':area_in_acres', $parkInfo['area_in_acres'], PDO::PARAM_INT);
    $insertData->bindValue(':description', $parkInfo['description'], PDO::PARAM_STR);
